                    ...
                    <div class="col-sm-8 offset-sm-2">
                        <form action="{{ route('users.update', $user->user_id) }}" method="POST">
                            ...
                            <div class="form-group">     
                                <strong>Name:</strong>                               
                                <input id="Name" type="text" value="{{ $user->name }}" name="name" class="form-control" placeholder="Name">
                            </div>
                            <div class="form-group">
                                <label class="form-control-label" for="exampleFormControlInput1">Email</label>
                                <input name="email" type="email" value="{{ $user->email }}" class="form-control" id="exampleFormControlInput1" placeholder="Email">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="roles" class="form-control">
                                    @foreach($roles as $role)
                                        <option value="{{ $role }}" {{ $user->getRoleNames() == $role ? 'selected' : '' }}>{{ $role }}</option>
                                    @endforeach
                                </select>
                            </div>
